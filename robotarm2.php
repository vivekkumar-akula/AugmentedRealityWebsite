...
<div class="view">
<model-viewer src="https://cdn.glitch.global/ee52e271-b171-4a14-8d53-7ec83fb2d0ba/robot_arm.glb?v=1685390145130" ios-src=""
...
margin-right: auto; margin-left: 10%; margin-right: 10%;"
  ...
  >
    ...
    <div class="body">
      <h1 style="font-family:'Times New Roman', Times;">A robot arm is a mechanical manipulator designed to perform various tasks in a similar manner to a human arm. It consists of multiple segments, known as links or joints, connected by joints that allow for movement and flexibility. </h1>
    <details>
      <summary>
        <span id="open" style="color:#0e0e52"><u>read more</u></span> 
      </summary>
      <h4 style="color: #0e0e52;">All about The ROBOT ARM</h4>
      <p style="color: #00296b;">Robot arms have revolutionized industries by automating tasks, improving productivity, and enhancing safety. They continue to advance in terms of precision, flexibility, and intelligent control, enabling them to handle increasingly complex tasks in diverse domains.</p>
    </details>
    </div>
    </div>
