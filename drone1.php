...
padding:20px;">
    ...
    <div style="height: 70%;"> <h3>Drone</h3>
...
margin-right: auto; margin-left: 10%; margin-right: 10%;">
    ...
    <div class="body">
      <h1 style="font-family:'Times New Roman', Times;">Drones have become increasingly popular in recent years, both for personal and commercial use.</h1>
    <details>
     <summary>
       <span id="open">read more</span> 
       <span id="close">close</span> 
     </summary>
      <h4 style="color: #0e0e52;"> Drone</h4>
      <p style="color: #00296b;">
        A drone is an unmanned aerial vehicle (UAV) that is controlled remotely or autonomously. Drones are often equipped with cameras, sensors, and other technology that allows them to perform a wide range of tasks. They can be used for military purposes such as surveillance and reconnaissance, as well as for civilian purposes such as aerial photography, search and rescue operations, and monitoring of agricultural crops or wildlife.

         They come in a variety of sizes and shapes, ranging from small hobby drones that can fit in the palm of your hand to large military drones that can fly at high altitudes and for extended periods of time.
        
        While drones have many practical applications, they also raise concerns about privacy, safety, and security. As a result, regulations have been put in place to govern the use of drones, particularly in urban areas and around airports.</p> </details>
    </div>
    </div>
</div>
<!-- Footer Start -->
