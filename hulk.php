...
<div class="view">
<model-viewer src="https://cdn.glitch.me/6955f85a-6b2c-4846-9b90-33a15e72fa44/hulk2.glb?v=1684404328580" ios-src=""
...
padding:20px;">
    ...
    <div style="height: 70%;"><h3>HULK</h3>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <img src="img/sh_hulk.png" class="img-fluid" alt="Responsive image">
      </div>
...
margin-right: auto; margin-left: 10%; margin-right: 10%;"
  ...
  >
    ...
    <div class="body">
      <h1 style="font-family:'Times New Roman', Times;">The Hulk made his debut in 1962.</h1>
    <details>
      <summary>
        <span id="open" style="color:#0e0e52"><u>read more</u></span> 
      </summary>
      <h4 style="color: #0e0e52;">All about Hulk</h4>
      <p style="color: #00296b;">Hulk is a super-strong and powerful character from the Marvel Universe. He's also known as Dr. Bruce Banner, a brilliant scientist who turns into the Hulk when he gets angry or stressed. As Hulk, he grows into a giant green monster with superhuman strength, durability, and regeneration abilities. He can leap miles in a single bound and smash through walls and other obstacles with ease. Despite his ferocious appearance and power, Hulk has a kind heart and wants to help others. He's often misunderstood because of his monstrous appearance, but his friends know that he's a good guy at heart.
        </p>
    </details>
    </div>
    </div>
