...
<div class="view">
<model-viewer src="https://cdn.glitch.global/ee52e271-b171-4a14-8d53-7ec83fb2d0ba/animated_drone_with_camera_free.glb?v=1685392386079" ios-src=""
...
padding:20px;">
    ...
    <div style="height: 70%;"><h3>Quadcopter Drone</h3>
...
margin-right: auto; margin-left: 10%; margin-right: 10%;"
  ...
  >
    ...
    <div class="body">
      <h1 style="font-family:'Times New Roman', Times;">Quadcopters are capable of performing impressive aerial acrobatics, including flips, rolls, and tight manoeuvres, making them a thrilling choice for drone enthusiasts. </h1>
    <details>
      <summary>
        <span id="open" style="color:#0e0e52"><u>read more</u></span> 
      </summary>
      <h4 style="color: #0e0e52;">All about The Quadcopter Drone</h4>
      <p style="color: #00296b;">A quadcopter is a type of unmanned aerial vehicle (UAV) that is powered by four rotors or propellers. It is known for its stability, manoeuvrability, and versatility. The four rotors are arranged in a symmetrical pattern, with two clockwise and two counterclockwise rotating propellers. By varying the speed of each rotor, a quadcopter can change its altitude, direction, and orientation. Quadcopters are popular for both recreational and professional use, including aerial photography and videography, surveillance, inspection, and even racing.</p>
    </details>
    </div>
    </div>
