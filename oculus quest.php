...
<div class="view">
<model-viewer src="https://cdn.glitch.global/63f1229f-7f6e-4bda-b0a8-d216d7241215/oculus_quest_vr_headset.glb?v=1678471855737  " ios-src=""
...
padding:20px;">
    ...
    <div style="height: 70%;"> <h3>OCULUS VR HEADSET</h3>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <img src="img/oculus quest vr headset.png" class="img-fluid" alt="Responsive image">
      </div>
...
margin-right: auto; margin-left: 10%; margin-right: 10%;">
    ...
    <div class="body">
      <h1 style="font-family:'Times New Roman', Times;">Oculus VR has been at the forefront of the virtual reality</h1>
    <details>
     <summary>
       <span id="open">read more</span> 
       <span id="close">close</span> 
     </summary>
      <h4 style="color: #0e0e52;">Oculus VR headsets</h4>
      <p style="color: #00296b;">
        Oculus VR is a virtual reality technology company that produces the Oculus Rift and Oculus Quest, two popular virtual reality headsets. The company was founded in 2012 by Palmer Luckey, Brendan Iribe, Nate Mitchell, and Michael Antonov. It was acquired by Facebook in 2014 for $2 billion.

The Oculus Rift was one of the first virtual reality headsets to gain widespread attention and popularity. It consists of a headset with two high-resolution displays, which provides users with an immersive 3D experience. The headset is tracked by an external camera, which allows users to move around in virtual spaces and interact with virtual objects</p>
    </details>
    </div>
    </div>
</div>
