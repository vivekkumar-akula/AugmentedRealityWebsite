...
<div class="view">
<model-viewer src="https://cdn.glitch.global/9730d0c9-d07f-4dc9-8514-5a81ea04dd29/shocker.glb?v=1685094056437" ios-src=""
...
padding:20px;">
    ...
    <div style="height: 70%;"><h3>SHOCKER</h3>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <img src="img/sh_shocker.png" class="img-fluid" alt="Responsive image">
      </div>
...
margin-right: auto; margin-left: 10%; margin-right: 10%;"
  ...
  >
    ...
    <div class="body">
      <h1 style="font-family:'Times New Roman', Times;">It is the first version of Spider Man.</h1>
    <details>
     <summary>
       <span id="open">read more</span> 
       <span id="close"></span> 
     </summary>
      <h4 style="color: #0e0e52;">All about Shocker</h4>
      <p style="color: #00296b;">Shocker, also known as Herman Schultz, is a fictional supervillain appearing in comic books published by Marvel Comics. He first appeared in The Amazing Spider-Man #46 in 1967. Shocker is an enemy of Spider-Man who uses gauntlets that can emit powerful vibrational shockwaves to commit crimes. His weapon is designed to shatter solid objects and make him nearly invulnerable to physical attacks. Despite being a relatively minor villain, Shocker has appeared in numerous Spider-Man comics, TV shows, and video games, and remains a fan favorite due to his unique powers and costume design.
      </p>
    </details>
    </div>
    </div>
