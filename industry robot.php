...
<div class="view">
<model-viewer src="https://cdn.glitch.me/cc334499-a5db-4f77-9c03-a1c4110a4860/industrial_robot.glb?v=1678469905242  " ios-src=""
...
padding:20px;">
    ...
    <div style="height: 70%;"> <h3>Industrial Robot</h3>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <img src="img/industrial robot.png" class="img-fluid" alt="Responsive image">
      </div>
...
margin-right: auto; margin-left: 10%; margin-right: 10%;">
    ...
    <div class="body">
      <h1 style="font-family:'Times New Roman', Times;"> An industrial robot is a robot system used for manufacturing</h1>
    <details>
     <summary>
       <span id="open">read more</span> 
       <span id="close">close</span> 
     </summary>
      <h4 style="color: #0e0e52;">Industrial robot</h4>
...
The international journal of robotics research and application. Subjects: EngineeringIndustrial engineering, design & manufacturing
</details>
    </div>
    </div>
</div>
