...
<div class="view">
<model-viewer src="https://cdn.glitch.global/9730d0c9-d07f-4dc9-8514-5a81ea04dd29/untitled.glb?v=1685093946675" ios-src=""
...
padding:20px;">
    ...
    <div style="height: 70%;"><h3>PROFESSOR HULK</h3>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <img src="img/sh_professorhulk.png" class="img-fluid" alt="Responsive image">
      </div>
...
margin-right: auto; margin-left: 10%; margin-right: 10%;"
  ...
  >
    ...
    <div class="body">
      <h1 style="font-family:'Times New Roman', Times;">Professor Hulk reappeared in Avengers EndGame</h1>
    <details>
      <summary>
        <span id="open" style="color:#0e0e52"><u>read more</u></span> 
      </summary>
      <h4 style="color: #0e0e52;">All about Professor Hulk</h4>
      <p style="color: #00296b;">Professor Hulk is one of a few alternate personas of Bruce Banner, but the creation of Professor Hulk is entirely unique compared to the other versions of the Hulk. Banner’s exposure to the gamma radiation that gave life to the Hulk fractured the scientist's mind and created multiple personalities living in one body. Bruce Banner, the Hulk, and Mr. Fixit (or Grey Hulk) all reside inside Banner’s mindscape, but the persona of Professor Hulk is unique in that his creation was in an effort to heal Banner’s fractured psyche. 
        </p>
    </details>
    </div>
    </div>
