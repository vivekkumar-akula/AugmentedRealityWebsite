...
margin-right: auto; margin-left: 10%; margin-right: 10%;"
  ...
  >
    ...
    <div class="body">
      <h1 style="font-family:'Times New Roman', Times;">A drone, also known as an unmanned aerial vehicle (UAV), is an aircraft without a human pilot on board. Drones are typically controlled remotely or programmed to fly autonomously. </h1>
    <details>
      <summary>
        <span id="open" style="color:#0e0e52"><u>read more</u></span> 
      </summary>
      <h4 style="color: #0e0e52;">All about The DRONE</h4>
      <p style="color: #00296b;">Camera Drones: These drones have built-in cameras for capturing photos and videos. They offer more advanced features, such as GPS positioning, stable flight controls, and higher-quality cameras.

Racing Drones: Racing drones are built for speed and agility. They are popular among enthusiasts who enjoy competitive drone racing events. These drones require more skill to operate due to their high speeds and maneuverability.</p>
    </details>
    </div>
    </div>
