...
<div class="view">
<model-viewer src="https://cdn.glitch.me/cc334499-a5db-4f77-9c03-a1c4110a4860/brushless_motor-4k-materialtest.glb?v=1678469128267 " ios-src=""
...
padding:20px;">
    ...
    <div style="height: 70%;"> <h3>BRUSHLESS MOTOR</h3>
...
margin-right: auto; margin-left: 10%; margin-right: 10%;">
    ...
    <div class="body">
      <h1 style="font-family:'Times New Roman', Times;">Brushed DC motors were invented in the 19th century and are still common.</h1>
    <details>
     <summary>
       <span id="open">read more</span> 
       <span id="close">close</span> 
     </summary>
      <h4 style="color: #0e0e52;"> Brushless Motor</h4>
      <p style="color: #00296b;">
        ...
        The advantages of a brushless motor over brushed motors are high power-to-weight ratio, high speed, nearly instantaneous control of speed (rpm) and torque, high efficiency, and low maintenance. </p>
    </details>
    </div>
    </div>
</div>
