...
<div class="view">
<model-viewer src="https://cdn.glitch.global/172b3830-5d34-421c-9269-6af28dc23859/rc_plane_alpha.glb?v=1685177922719" ios-src=""
...
padding:20px;">
    ...
    <div style="height: 70%;"><h3>RC PLANE</h3>
...
margin-right: auto; margin-left: 10%; margin-right: 10%;"
  ...
  >
    ...
    <div class="body">
      <h1 style="font-family:'Times New Roman', Times;"> RC (Radio-Controlled) plane is a miniature model aircraft that can be operated remotely using a handheld transmitter or controller. </h1>
    <details>
      <summary>
        <span id="open" style="color:#0e0e52"><u>read more</u></span> 
      </summary>
      <h4 style="color: #0e0e52;">All about The RC PLANE</h4>
      <p style="color: #00296b;">The construction of an RC plane typically involves lightweight materials such as foam, balsa wood, or carbon fiber, which allow the aircraft to be agile and maneuverable. The plane is equipped with servos that control the various movable surfaces, including the ailerons, elevators, and rudder, enabling the pilot to control the plane's movements in the air. The power is provided by an electric motor or a small internal combustion engine, depending on the model.</p>
    </details>
    </div>
    </div>
