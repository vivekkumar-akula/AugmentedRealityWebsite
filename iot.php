...
session_start();
  ...
  if(mysqli_connect_error())
  {
    ...
    $query = "SELECT * FROM `items` WHERE branch='IOT'";
...
<head>
    ...
    <meta name="description" content="What is IoT? The Internet of Things (IoT) describes the network of physical objects—“things”—that are embedded with sensors, software, and other technologies for the purpose of connecting and exchanging data with other devices and systems over the internet."/>
    <meta name="description" content="IOT"/>
    <meta content="Iot edodwaja" name="keywords">
    <meta name="description" content="iot edodwaja"/>
    <!-- Favicon -->
...
<body style="background-color: #061429;">
 ...
 <script>document.addEventListener('contextmenu', event => event.preventDefault());</script>
    ...
    <div class="container-fluid position-relative p-0">
        ...
        <div class="container-fluid bg-primary py-5" style="margin-bottom: 90px;background: linear-gradient(rgba(9, 30, 62, .7), rgba(9, 30, 62, .7)), url(../img/bckg_iot.jpg) center center no-repeat;
    background-size: cover;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">INTERNET OF THINGS</h1>
