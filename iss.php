...
<div class="view">
<model-viewer src="https://cdn.glitch.global/cc334499-a5db-4f77-9c03-a1c4110a4860/iss.glb?v=1678470145655 " ios-src=""
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <img src="img/iss.png" class="img-fluid" alt="Responsive image">
      </div>
...
margin-right: auto; margin-left: 10%; margin-right: 10%;">
    ...
    <div class="body">
      <h1 style="font-family:'Times New Roman', Times;">International Space Station, which is a habitable artificial satellite</h1>
    <details>
     <summary>
       <span id="open">read more</span> 
       <span id="close">close</span> 
     </summary>
      <h4 style="color: #0e0e52;">ISS</h4>
