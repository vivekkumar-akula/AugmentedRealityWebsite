...
<div class="view">
<model-viewer src="https://cdn.glitch.global/cc334499-a5db-4f77-9c03-a1c4110a4860/scene.gltf?v=1678471497808  " ios-src=""
...
padding:20px;">
    ...
    <div style="height: 70%;"> <h3>STRAY ROBOT</h3>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <img src="img/strayrobotqr.png" class="img-fluid" alt="Responsive image">
      </div>
...
margin-right: auto; margin-left: 10%; margin-right: 10%;">
    ...
    <details>
     <summary>
      ...
      <h4 style="color: #0e0e52;">All about Satellite </h4>
      <p style="color: #00296b;">
        A satellite is an artificial object that is placed into orbit around the Earth or another celestial body. Satellites have many different applications, including communications, navigation, remote sensing, and scientific research. Satellites can be placed in different orbits depending on their intended use, and their capabilities can vary depending on their design and technology.

One of the most common uses of satellites is for communication. Satellites can be used to provide global coverage for television, internet, and telephone services. This is achieved by placing a network of communication satellites in geostationary orbit, which means that they remain in a fixed position relative to the Earth's surface. </p>
    </details>
    </div>
    </div>
</div>
