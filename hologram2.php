...
<div class="view">
<model-viewer src="https://cdn.glitch.global/ee52e271-b171-4a14-8d53-7ec83fb2d0ba/looking_glass_hologram_1.glb?v=1685386942770" ios-src=""
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <img src="img/hologram2.png" class="img-fluid" alt="Responsive image">
      </div>
...
margin-right: auto; margin-left: 10%; margin-right: 10%;"
  ...
  >
    ...
    <div class="body">
      <h1 style="font-family:'Times New Roman', Times;">Holograms are created using the principle of interference, where light waves interact to produce an interference pattern. This pattern is captured and stored in a medium, which is then used to recreate the original object or scene when illuminated with appropriate light. </h1>
    <details>
      <summary>
        <span id="open" style="color:#0e0e52"><u>read more</u></span> 
      </summary>
      <h4 style="color: #0e0e52;">All about The HOLOGRAM</h4>
      <p style="color: #00296b;">Transmission Holograms: These holograms allow light to pass through them, creating a three-dimensional image that can be viewed from different angles.
Reflection Holograms: These holograms reflect light, creating a three-dimensional image that appears in front of the holographic surface.</p>
    </details>
    </div>
    </div>
