...
session_start();
  ...
  if(mysqli_connect_error())
  {
    ...
    $query = "SELECT * FROM `items` WHERE branch='ROBOTICS'";
...
<body style="background-color: #061429;">
 ...
 <script>document.addEventListener('contextmenu', event => event.preventDefault());</script>
    ...
    <div class="container-fluid position-relative p-0">
        ...
        <div class="container-fluid bg-primary py-5 " style="margin-bottom: 90px;background: linear-gradient(rgba(9, 30, 62, .7), rgba(9, 30, 62, .7)), url(../img/bckg_robo.jpg) center center no-repeat; background-size: cover;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">ROBOTICS</h1>
