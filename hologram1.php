...
<div class="view">
<model-viewer src="https://cdn.glitch.global/ee52e271-b171-4a14-8d53-7ec83fb2d0ba/untitled.glb?v=1685386538232" ios-src=""
...
padding:20px;">
    ...
    <div style="height: 70%;"><h3>HOLOGRAM</h3>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <img src="img/hologram1.png" class="img-fluid" alt="Responsive image">
      </div>
...
margin-right: auto; margin-left: 10%; margin-right: 10%;"
  ...
  >
    ...
    <div class="body">
      <h1 style="font-family:'Times New Roman', Times;">A hologram is a three-dimensional image created through the use of light diffraction. Unlike traditional two-dimensional images, holograms appear to have depth, allowing viewers to see the image from different angles.</h1>
    <details>
      <summary>
        <span id="open" style="color:#0e0e52"><u>read more</u></span> 
      </summary>
      <h4 style="color: #0e0e52;">All about The HOLOGRAM</h4>
      <p style="color: #00296b;">Holography, the technique used to create holograms, involves recording the interference pattern of light waves scattered off an object or scene. This pattern is captured on a photosensitive medium such as photographic film or a digital sensor. When the recorded hologram is illuminated with coherent light, such as laser light, it recreates the original scene in three dimensions, seemingly floating in space.</p>
    </details>
    </div>
    </div>
