...
<div class="view">
<model-viewer src="https://cdn.glitch.global/cc334499-a5db-4f77-9c03-a1c4110a4860/esp8266.glb?v=1678470217669  " ios-src=""
...
padding:20px;">
    ...
    <div style="height: 70%;"> <h3>ESP 8266</h3>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <img src="img/isp8266.png" class="img-fluid" alt="Responsive image">
      </div>
...
margin-right: auto; margin-left: 10%; margin-right: 10%;">
    ...
    <div class="body">
      <h1 style="font-family:'Times New Roman', Times;">These microcontroller chips have been succeeded by the ESP32 family of devices.</h1>
    <details>
     <summary>
       <span id="open">read more</span> 
       <span id="close">close</span> 
     </summary>
      <h4 style="color: #0e0e52;">ESP 8266</h4>
