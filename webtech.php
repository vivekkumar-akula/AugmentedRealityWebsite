...
session_start();
  ...
  if(mysqli_connect_error())
  {
    ...
    $query = "SELECT * FROM `items` WHERE branch='WEB'";
...
<body style="background-color: #061429;">
    ...
    <div class="container-fluid position-relative p-0">
        ...
        <div class="container-fluid bg-primary py-5" style="margin-bottom: 90px;background: linear-gradient(rgba(9, 30, 62, .7), rgba(9, 30, 62, .7)), url(../img/spa.jpg) center center no-repeat;
    background-size: cover;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">SPACE SHUTTLE</h1>
